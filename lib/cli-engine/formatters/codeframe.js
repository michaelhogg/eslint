...
function formatMessage(message, parentResult) {
    ...
    /** @see babeljs.io/docs/en/next/babel-code-frame.html */
    const codeFrameLocation = {
        start: {
            line:   message.line,
    ...
    /** @see babeljs.io/docs/en/next/babel-code-frame.html#options */
    ...
    if (sourceCode) {
        result.push(
            codeFrameColumns(sourceCode, codeFrameLocation, codeFrameOptions)
        );
    }
